...
* **No ONNX model ships with this repository.** MediaPipe's
  ``hand_landmarker.task`` is a bundle of TFLite graphs and metadata, not an
  ONNX file, and it cannot be renamed into one. Point
  :class:`OnnxLandmarkBackend` at your own exported model to use this path.
